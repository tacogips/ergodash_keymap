 ...
 * ,-------------------------------------------------------------------------------------------------------------------------.
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | ESC  |   A  |   S  |   D  |   F  |   G  | ESC  |                    |   H  |   J  |   K  |   L  |   ;  |  "   | Shift|
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Bksp | Shift|   Z  |   X  |   C  |   V  |   B  |                    |   N  |   M  |   ,  |   .  |   /  |  Up  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Tab  |  GUI |  ALt |  ALt |||||||| Shift| Ctrl |  Space |||||||| Space |Shift| ALt ||||||||Down |Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(	\
    K_GRV,   KC_1,     KC_2,    KC_3,   KC_4,    KC_5,   KC_6,     										KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSLS, KC_EQL k  \
    KC_TAB,  KC_Q,     KC_W     KC_E,   KC_R,    KC_T,   KC_ESC,                       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,  \
    KC_ESC,  KC_A,     KC_S,    KC_D,   KC_F,    KC_G,   KC_ESC,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_LSFT,  \
    KC_BSPC, KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,   KC_B,                         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_LSFT,   \
    KC_TAB,  KC_LGUI,  KC_LALT,     KC_LALT,     KC_LSFT,  KC_LCTL, KC_SPC,        KC_SPC, KC_LSFT, KC_LALT,    KC_DOWN,     KC_LEFT, KC_DOWN,  KC_RGHT  \
  )
