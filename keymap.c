 ...
 * ,-------------------------------------------------------------------------------------------------------------------------.
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Enter|  GUI |  ALt |  ALt |||||||| Shift| Ctrl |  Space |||||||| Space |Shift| ALt ||||||||Down |Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
			\
    KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,   KC_6,     										KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSLS, KC_EQL k  \
    KC_TAB,  K_GRV,   KC_Q,    KC_W    KC_E,    KC_R,   KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,  \
    ...
    KC_ENT, KC_LGUI, KC_LALT,     KC_LALT,     KC_LSFT, KC_LCTL, KC_SPC,        KC_SPC, KC_LSFT, KC_LALT,    KC_DOWN,  KC_LEFT, KC_DOWN,  KC_RGHT  \
  )
