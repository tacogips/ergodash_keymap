...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_DLR,  KC_A,     KC_S,     KC_D,   KC_F,  KC_G,    KC_ESC,                  KC_ESC,  KC_H,     KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_RBRC,   \
    KC_0,    KC_ASTR,  KC_Z,     KC_X,   KC_C,  KC_V,    KC_B,                    KC_PERC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,       \
