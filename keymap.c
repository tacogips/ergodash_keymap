...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Enter| BS |  Del |  ALt |||||||| Space | Ctrl |Shift|||||||| Alt  | Shift | Space|||||||| Ctrl | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_ENT,  KC_BSPC,  KC_DEL,  KC_LALT, KC_SPC, KC_LCTL, KC_LSFT,        KC_LALT, KC_LSFT, KC_SPC, KC_LCTL,     KC_LEFT, KC_DOWN,  KC_RGHT \
  ),
